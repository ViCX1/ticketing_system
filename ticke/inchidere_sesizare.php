...
$Status_sesizare = 'inactiva'; //"$_REQUEST[Status_sesizare]"; 
...
required value="<?php echo $row['technician'];?>" readonly/></p>

<p><input name="submit" type="submit" value="Inchidere sesizare" /></p>
</form>
<?php } ?>
</div>
</div>
